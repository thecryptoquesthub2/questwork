    ...
    <>
      <div
        ...
        <div style={{ display: 'flex', gap: '8px', alignItems: 'center' }}>
          ...
          <button
            onClick={() => { haptic('medium'); applied ? null : setShowApply(true) }}
            style={{
          ...
          <div
            ...
            <textarea
              ...
              style={{
                ...
                background: dark ? 'rgba(44,44,46,0.8)' : 'rgba(230,230,235,0.6)',
                border: `1px solid ${colors.border}`,
            ...
            <div style={{
              ...
              border: `1px solid ${colors.border}`,
              fontSize: '11px', color: colors.text2, lineHeight: 1.6
            }}>
            ...
            <div style={{ display: 'flex', gap: '10px', marginTop: '16px' }}>
              ...
              <button
                ...
                }}>{applying ? 'Submitting...' : 'Submit →'}</button>
            </div>
          </div>
        </div>
      )}
  ...
  return (
    <div style={{ padding: '24px 20px', width: '100%', boxSizing: 'border-box' }}>
      ...
      <div style={{ display: 'flex', gap: '8px', overflowX: 'auto', paddingBottom: '16px' }}>
        {['All', 'Community', 'BD', 'Dev', 'Social', 'Writing'].map((cat, i) => (
          <button key={cat} onClick={() => { haptic('light'); setFilter(i === 0 ? 'All' : categories[i]) }} style={{
            padding: '7px 14px', borderRadius: '20px', whiteSpace: 'nowrap',
  ...
  const sections = [
    {
      title: 'Preferences',
      items: [
        { icon: '🎨', label: 'Appearance', value: dark ? 'Dark' : 'Light', arrow: true },
        { icon: '🔔', label: 'Notifications', value: 'On', arrow: true },
      ]
    },
    {
      title: 'Help',
      items: [
        { icon: '💬', label: 'Support', value: '', arrow: true, action: () => { haptic('light'); window.open('https://t.me/QuestWorkSupport') } },
        { icon: 'ℹ️', label: 'Information', value: '', arrow: true },
        { icon: '🔒', label: 'Privacy Policy', value: '', arrow: true },
        { icon: '📋', label: 'Terms & Conditions', value: '', arrow: true },
      ]
    },
    {
      title: 'QuestWork Social',
      items: [
        { icon: '📸', label: 'Instagram', value: '@questwork.io', arrow: true, action: () => { haptic('light'); window.open('https://www.instagram.com/questwork.io') } },
      ]
    }
  ]
    ...
    <div style={{ padding: '24px 20px', width: '100%', boxSizing: 'border-box' }}>
      ...
      <div style={{
          ...
          <div style={{ flex: 1 }}>
            ...
            <div style={{ display: 'flex', gap: '6px', marginTop: '8px', flexWrap: 'wrap' }}>
              <div style={{
                ...
                background: isPremium ? 'rgba(245,200,66,0.15)' : colors.accentBg,
                color: isPremium ? '#F5C842' : colors.accent,
                fontWeight: '600', border: `1px solid ${colors.accentBorder}`
              }}>
                {isPremium ? '👑 Premium' : '🆓 Free Plan'}
              </div>
              <div style={{
                fontSize: '11px', padding: '3px 10px', borderRadius: '20px',
                background: availability === 'Available' ? 'rgba(52,211,153,0.1)' : colors.surface2,
                color: availability === 'Available' ? '#34d399' : colors.text2,
                fontWeight: '500', border: `1px solid ${availability === 'Available' ? 'rgba(52,211,153,0.3)' : colors.border}`
              }}>
        ...
        <div style={{ marginBottom: '14px' }}>
          ...
          <div style={{ display: 'flex', gap: '8px' }}>
            {['Available', 'Busy', 'Open to Offers'].map(a => (
              <button key={a} onClick={() => { haptic('light'); setAvailability(a) }} style={{
                flex: 1, padding: '8px 4px', borderRadius: '10px', fontSize: '10px', fontWeight: '600',
                background: availability === a ? colors.btnBg : colors.surface2,
                border: `1px solid ${availability === a ? colors.btnBg : colors.border}`,
                color: availability === a ? colors.btnText : colors.text2,
                cursor: 'pointer'
              }}>{a}</button>
            ))}
          </div>
        ...
        <div style={{ marginBottom: '14px' }}>
          ...
          <input
            ...
            placeholder="e.g. Community Management, BD, Writing..."
            style={{
        ...
        <button onClick={handleSave} style={{
          ...
          color: saved ? '#34d399' : colors.btnText,
      ...
      <div style={{
        ...
        {[
          ...
          { icon: '💼', label: 'Applications Sent', value: '0' },
          { icon: '✅', label: 'Gigs Completed', value: '0' },
          { icon: '💰', label: 'Total Earned', value: '$0 USDT' },
        ].map((item, i) => (
          <div key={i} style={{
      ...
      <div
        ...
        <div>
          ...
          <div style={{ fontSize: '12px', color: colors.text2, marginTop: '2px' }}>AI features, priority visibility & more</div>
        </div>
        <div style={{
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
          <div>
            ...
            <div style={{ fontSize: '12px', color: colors.text2, marginTop: '3px' }}>Courses, guides & more</div>
          </div>
          <div style={{
            fontSize: '10px', padding: '4px 10px', borderRadius: '20px',
            background: 'rgba(96,165,250,0.1)', color: '#60a5fa',
            border: '1px solid rgba(96,165,250,0.2)', fontWeight: '600',
          ...
          <div style={{
            ...
            {section.items.map((item, ii) => (
              <div
                ...
                {item.value && <span style={{ fontSize: '13px', color: colors.text2 }}>{item.value}</span>}
      ...
      {showPayment && (
        <div
          ...
          <div
            ...
            <div style={{ width: '40px', height: '4px', borderRadius: '2px', background: colors.border, margin: '0 auto 20px' }}/>
            <div style={{ fontSize: '22px', fontWeight: '700', marginBottom: '4px', letterSpacing: '-0.3px', textAlign: 'center' }}>✨ Go Premium</div>
            <div style={{ fontSize: '13px', color: colors.text2, marginBottom: '24px', textAlign: 'center' }}>Unlock AI features, priority visibility & more</div>

            <div style={{ background: colors.surface2, borderRadius: '14px', padding: '14px', marginBottom: '20px', border: `1px solid ${colors.border}` }}>
              {['✨ AI Pitch Writer', '🔝 Priority Visibility', '⭐ Premium Badge', '📊 Advanced Analytics', '🤖 AI Job Matching', '💬 Direct Client Invites', '📝 Unlimited Applications'].map((f, i) => (
                <div key={i} style={{ fontSize: '13px', padding: '6px 0', borderBottom: i < 6 ? `1px solid ${colors.border}` : 'none', color: colors.text }}>{f}</div>
              ))}
            </div>

            <div style={{ textAlign: 'center', marginBottom: '20px' }}>
              <span style={{ fontSize: '36px', fontWeight: '800', letterSpacing: '-1px' }}>$15</span>
              <span style={{ fontSize: '16px', color: colors.text2 }}>/month</span>
            </div>
            ...
            <div style={{ background: colors.surface2, borderRadius: '14px', padding: '16px', marginBottom: '16px', border: `1px solid ${colors.border}` }}>
              ...
              <div style={{ fontSize: '12px', fontFamily: 'monospace', color: colors.text, wordBreak: 'break-all', lineHeight: 1.6 }}>
                THXAwQnQ22bjq3C862C4yejXcFeEZ8dcJW
              </div>
              <button
                onClick={() => { haptic('medium'); navigator.clipboard.writeText('THXAwQnQ22bjq3C862C4yejXcFeEZ8dcJW'); alert('Address copied!') }}
                style={{
                  width: '100%', marginTop: '10px', padding: '10px', borderRadius: '10px', cursor: 'pointer',
                  background: colors.accentBg, border: `1px solid ${colors.accentBorder}`,
            ...
            <div style={{ background: colors.surface2, borderRadius: '14px', padding: '14px', marginBottom: '16px', border: `1px solid ${colors.border}`, fontSize: '12px', color: colors.text2, lineHeight: 1.6 }}>
              ⚠️ After sending, DM <strong>@QuestWorkSupport</strong> with your transaction hash to activate Premium instantly.
            </div>

            <button
              onClick={() => { haptic('medium'); window.open('https://t.me/QuestWorkSupport', '_blank'); setShowPayment(false) }}
              style={{
                width: '100%', padding: '16px', borderRadius: '14px',
                background: colors.btnBg, border: 'none',
                color: colors.btnText, fontSize: '16px', fontWeight: '700', cursor: 'pointer'
              }}>I've Sent Payment →</button>

            <button
              onClick={() => { haptic('light'); setShowPayment(false) }}
              style={{
                width: '100%', padding: '12px', borderRadius: '14px', marginTop: '10px',
                background: 'none', border: 'none', color: colors.text2, fontSize: '14px', cursor: 'pointer'
              }}>Cancel</button>
          </div>
        </div>
      )}
